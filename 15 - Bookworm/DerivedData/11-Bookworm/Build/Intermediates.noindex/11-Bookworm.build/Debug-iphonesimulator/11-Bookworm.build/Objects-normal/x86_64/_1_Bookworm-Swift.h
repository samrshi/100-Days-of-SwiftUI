...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="_1_Bookworm",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11_1_Bookworm11AppDelegate")
...
@interface Book (SWIFT_EXTENSION(_1_Bookworm))
...
@property (nonatomic, copy) NSString * _Nullable review;
...
SWIFT_CLASS("_TtC11_1_Bookworm13SceneDelegate")
...
@interface Student (SWIFT_EXTENSION(_1_Bookworm))
@property (nonatomic, copy) NSUUID * _Nullable id;
